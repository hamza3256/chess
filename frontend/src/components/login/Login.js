...
const LoginFrameBlock = styled.form`
  display: flex;
  ...
  @keyframes blinking {
    ...
    50% {
      box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.56),
        0 3px 1px -2px rgba(0, 0, 0, 0.8), 0 1px 5px 0 rgba(0, 0, 0, 0.48);
    }
    100% {
      box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.14),
        0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 1px 5px 0 rgba(0, 0, 0, 0.12);
      ...
      <LoginFormBlock>
        ...
        <InputFrameBlock>
          ...
          >
            ...
            />
            <ErrorBlock>{error.username}</ErrorBlock>
          </InputFormBlock>
          <InputFormBlock
          ...
          {register ? (
            ...
            >
              ...
              />
              <ErrorBlock>{error.passwordConfirm}</ErrorBlock>
            </InputFormBlock>
          ) : null}
          {login ? (
            <OptionFormBlock>
              <SaveInputFormBlock>
                <SaveInputBlock type='checkbox' />
                <SaveInputTextBlock>Remember Me</SaveInputTextBlock>
              </SaveInputFormBlock>
              <ForgetBlock>Forget password?</ForgetBlock>
            </OptionFormBlock>
          ) : null}
        </InputFrameBlock>
        <SubmitFrameBlock>
          <SubmitBlock type='submit'>Submit</SubmitBlock>
          {login ? (
            <CreateFormBlock>
              <CreateBlock>Don't have an account?</CreateBlock>
              <CreateButtonBlock type='button' onClick={onRegister}>
                Create
              </CreateButtonBlock>
            </CreateFormBlock>
          ) : (
            <CreateFormBlock>
              <CreateBlock>Don't have an account?</CreateBlock>
              <CreateButtonBlock type='button'>Create</CreateButtonBlock>
            </CreateFormBlock>
          )}
        </SubmitFrameBlock>
      </LoginFormBlock>
