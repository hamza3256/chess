...
const CanvasRow = React.memo(
  ({ row, y, cellSize, onClickCell, pieceConverter }) => {
...
const CanvasCell = React.memo(
  ({ cell, cellSize, cellNum, onClick, pieceConverter, y, x }) => {
...
const Canvas = ({ onContextMenu, replayMode, billBoard, ...rest }) => {
  return (
    <>
      ...
      <CanvasBlock replayMode={replayMode} onContextMenu={onContextMenu}>
        <CanvasContent {...rest} />
