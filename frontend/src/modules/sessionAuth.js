...
export const initializeValue = createAction(
  INITIALIZE_VALUE,
  (payload) => payload
);
export const clearValue = createAction(CLEAR_VALUE);

const [SET_SESSION, SET_SESSION_SUCCESS, SET_SESSION_FAILURE] =
  createRequestActionTypes("sessionAuth/SET_SESSION");
export const setSessionThunk = createRequestThunk(
  SET_SESSION,
  authAPI.getSession
);

const [LOGIN, LOGIN_SUCCESS, LOGIN_FAILURE] =
  createRequestActionTypes("sessionAuth/LOGIN");
const [REGISTER, REGISTER_SUCCESS, REGISTER_FAILURE] = createRequestActionTypes(
  "sessionAuth/REGISTER"
);
const [LOGOUT, LOGOUT_SUCCESS, LOGOUT_FAILURE] =
  createRequestActionTypes("sessionAuth/LOGOUT");
const [CHECK, CHECK_SUCCESS, CHECK_FAILURE] =
  createRequestActionTypes("sessionAuth/CHECK");
...
export const clearSpecificField = createAction(
  CLEAR_SPECIFIC_FIELD,
  (payload) => payload
);
